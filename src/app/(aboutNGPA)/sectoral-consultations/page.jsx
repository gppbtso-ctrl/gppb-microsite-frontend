...
const ConsultationMeeting2023 = [
  ...
  },
  {
    ...
    subjectMatter:
      "Kick-off and Planning Workshop for the Scaling of Sustainable Consumption on Production in the Philippines ",
    attendeesSectors:
      "Green Public Procurement Focal Persons from the GPPB-member agencies",
  },
  {
    date: "19 May 2023",
  ...
  },
  {
    ...
    attendeesSectors:
      "Department of National Defense, Armed Forces of the Philippines, Philippine Air Force, and Government Arsenal ",
  },
  {
    date: "24 May 2023 ",
  ...
  },
  {
    date: "24 May 2023 ",
    subjectMatter:
      "Procurement of requirements relating to research and development ",
    attendeesSectors:
      "Research and Development Sector (Departments of Agriculture, Science and Technology, and Commission on Higher Education) ",
  },
  {
    date: "07 June 2023",
    subjectMatter:
      "Micro, Small, Medium Enterprises and Beneficial Ownership on government procurement to compare regional practices within Asia ",
    attendeesSectors:
      "International Exchange with the LKPP of Indonesia (counterpart of GPPB-TSO) ",
  },
  {
    date: "23 June 2023 ",
  ...
  },
  {
    date: "27 June 2023 ",
    subjectMatter:
      "Technical Working Group on the Adoption of Digital Payments (Executive Order No. 170) in relation to Procurement of Digital Payment Providers ",
    attendeesSectors: "BSP, BTr, BIR, COA, LBP ",
  },
  {
    date: "29 June 2023, 25 July 2023",
    subjectMatter:
      "Proposed Inclusion of Cloud Computing Services, Airline Tickets under Government Fares Agreement, and Government of the Philippines - Automobile Framework Program in the PS List of Common-Use Supplies and Equipment ",
    attendeesSectors: "PS ",
  },
  {
    date: "19 July 2023 ",
    ...
    attendeesSectors:
      "Ministry of Social Services and Development-Bangsamoro Autonomous Region in Muslim Mindanao (MSSD-BARMM),  ",
  },
  {
    date: "20 July 2023 ",
    ...
    attendeesSectors: (
      <>
        MSSD-BARMM; <br /> COA; <br /> BSP; <br />
        United Nations International Childrens Emergency Fund; <br />
        LBP; <br />
        Development Bank of the Philippines; <br />
        Makati Local Government Unit; <br />
        Mynt (GCash); <br />
        Maya; <br />
        Palawan Pay; <br />
        P.J. Lhuillier Inc. (Cebuana Lhuillier); <br />
        and M Lhuillier Financial Services Inc.{" "}
      </>
    ),
  },
  {
    date: "31 July 2023 ",
    subjectMatter:
      "Post-Qualification Requirements in the Procurement of Agricultural and Fisheries Machinery ",
    attendeesSectors: "Bureau of Agricultural and Fisheries Engineering    ",
  },
  {
    date: "8 August 2023 ",
    subjectMatter:
      "Guidelines for the Procurement of Information and Communications Technology (ICT) Resources ",
    attendeesSectors:
      "ICT Sector  (Department of Information and Communications Technology as Lead) ",
  },
  {
    date: "5 September 2023 ",
    subjectMatter:
      "Domestic preference Small and Medium Enterprises participation Women entrepreneurs support  Shared Service Facilities (SSF) ",
...

  {
    ...
    subjectMatter:
      "Procurement of Books and other Printed Educational Materials ",
          ...
          <table className="w-full text-left mt-2">
            ...
            <tbody>
              <tr>
                <td
                  colSpan={3}
                  className="bg-blue-900 px-5 border border-black"
                >
              ...
              <tr>
                ...
                >
                  <span className="font-sans block text-justify">
                    Performance Securities – Issuance of Surety or Insurance
                    Bonds
                  </span>
                </td>
                <td
              ...
              <tr>
                ...
                >
                  <span className="font-sans block text-justify">
                    ...
                    Development Authority; Department of Trade and Industry
              ...
              <tr>
                ...
                >
                  <span className="font-sans block text-justify">
                    Workshop on Use Cases of Beneficial Ownership Information in
                    Preventing and Investigating Cases of Corruption and
                ...
                >
                  <span className="font-sans block text-justify">
                    United Nations Office on Drugs and Crime and Participants
                    from GPPB-TSO
                  </span>
                </td>
              </tr>
              ...
              {ConsultationMeeting2023.map(
                ({ date, subjectMatter, attendeesSectors }, index) => {
                  return (
                    <>
                      <tr key={index}>
                        <td
                        ...
                        >
                          <div className="flex flex-col gap-4">
                            <span className="font-sans block  ">{date}</span>
                          </div>
                        </td>
                        <td
                          className={`p-3 break-words border border-black align-top max-w-10`}
              ...
              <tr>
                ...
                >
                  <span className="font-sans block text-justify">
                    Pre-Meeting for and Roundtable Discussion on Public
