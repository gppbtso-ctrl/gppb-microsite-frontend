  ...
  },
  {
    ...
    col2: (
      <>
        ...
        <Typography className="text-justify inline ml-2.5">
        A consolidated matrix of pending bills before the HoR and Senate was prepared by the HOs as part of preparatory materials for the scheduled GPPB Meeting on 08 June 2023.         
  ...
  },
  {
    ...
    col2: (
      <>
        ...
        <Typography className="text-justify inline ml-2.5">
        The 2nd Consultation Meeting with the Committee on Revision of Laws (Com Sec and staff only) was attended by the GPPB-TSO to further appraise the committee on the nuances of the current procurement rules and regulations.          
  ...
  },
  {
    ...
    col2: (
      <>
        ...
        <Typography className="text-justify inline ml-2.5">
        The GPPB-TSO received the comments of the PS-DBM re Proposed Substitute Bill for House Bill Nos. 18, 648, 1503, 2682, 3704, 4617, and 6280.          
        </Typography>
      </>
    ),
  },
  {
    ...
    col2: (
      <>
        ...
        <Typography className="text-justify inline ml-2.5">
        The 3rd Consultation Meeting with the Committee on Revision of Laws (Com Sec and staff only) was attended by the GPPB-TSO to further apprise the committee on the nuances of the current procurement rules and regulations.          
        </Typography>
      </>
    ),
  },
  ...
  },
  {
    ...
    col2: (
      <>
        ...
        <Typography className="text-justify inline ml-2.5">
        Meeting with DBM Office of the Secretary, PS and GPPB-TSO re: proposed provisions         
        </Typography>
      </>
    ),
  },
  ...
  },
  {
    ...
    col2: (
      <>
        ...
        <Typography className="text-justify inline ml-2.5">
        Physical Meeting with DBM Office of the Secretary, PS and GPPB-TSO re: proposed provisions        
        </Typography>
      </>
    ),
  },
...

  {
    ...
    col2: (
      <>
        ...
        <Typography className="text-justify inline ml-2.5">
        Meeting of Committee on Revision of Laws on the Executive Department’s proposed amendments to RA No. 9184. Likewise, the Committee submitted and presented its updated Bill amending RA No. 9184.        
...
const dhr = [
  {
    ...
    col2: (
      <>
        ...
        <Typography className="text-justify inline ml-2.5">
        Meeting of Committee on Revision of Laws to deliberate the proposed amendments to RA No. 9184 by the House and Executive Department.        
        </Typography>
      </>
    ),
  },
  {
    ...
    col2: (
      <>
        ...
        <Typography className="text-justify inline ml-2.5">
        Finalization of the proposed amendments to RA No. 9184 for submission to the Committee on Revision of Laws.         
        </Typography>
      </>
    ),
  },
  {
    ...
    col2: (
      <>
        ...
        <Typography className="text-justify inline ml-2.5">
        Approval of the Committee on Revision of Laws of the House Bill amending RA No. 9184.       
        </Typography>
      </>
    ),
  },

  {
    ...
    col2: (
      <>
        ...
        <Typography className="text-justify inline ml-2.5">
        The House of Representatives approved on Second Reading proposed amendments to the procurement law.         
        </Typography>
      </>
    ),
  },
  {
    ...
    col2: (
      <>
        ...
        <Typography className="text-justify inline ml-2.5">
        Plenary Hearing on the House Bill Amending RA No. 9184. (3rd Reading) and Endorsement of the same to the Senate.      
        </Typography>
      </>
    ),
  },
...
export default function HORHearings() {
  ...
  return (
    <div className="relative flex justify-center items-center z-10">
      <Card className="relative p-5 m-3 max-w-4xl shadow-md rounded-none flex flex-col gap-3">
      <Carousel
       autoplay={true}
       loop={true}
     ...
     <img
        ...
        <Typography color="white" variant="lead" className="font-sans absolute top-14 left-5">HOR Hearing - April 19</Typography>
        </div>
      </div>
