    ...
    <>
      ...
      <div className="relative min-h-screen">
        <section class="relative flex flex-col min-h-screen bg-slate-800 text-white  bg-blend-overlay  bg-cover  bg-[url('/Home.png')] z-10">
          ...
          <div
            className="absolute bottom-2 left-[50%] -translate-x-1/2  mx-auto flex flex-col items-center mb-5"
            ref={scrollDown}
          >
            <FontAwesomeIcon
        ...
        <div className="absolute w-full  h-full top-10 z-0">
          ...
          <section class="relative flex flex-col h-fit  bg-gradient-to-b  from-[#0C2D48] to-[#003B73] bg-blend-overlay text-white  -mt-1  z-20">
        ...
        <ScrollToTop
          smooth
          className=" !bg-transparent !shadow-none ml-[10rem]"
          component={
