  ...
  return (
    ...
    <div className="relative min-h-screen">
      ...
      <div className="absolute w-full  h-full top-10 z-0">
        ...
        <section class="relative flex flex-col h-fit  bg-gradient-to-b  from-[#0C2D48] to-[#003B73] bg-blend-overlay text-white    z-10">
          <div className="w-full mt-[3rem]  rounded-lg flex flex-row gap-1 justify-between border border-blue-800/15 p-5 px-[4.5rem] shadow-lg backdrop-blur-md bg-gradient-to-b  from-[#0C2D48]/10 to-[#003B73]">
         ...
         GPPB-TSO Building, Commonwealth Ave, <br/>UP Diliman Campus, Quezon City
          ...
          <Typography className=" text-lg mt-2 mb-2 tracking-wide font-light hover:text-blue-50 antialiased text-blue-400 underline cursor-pointer text-center md:text-left drop-shadow-xl">
          ...
          <div className="flex gap-4 items-center  text-blue-gray-900 mt-2 ">
              <Typography
                as="a"
                className=" antialiased text-white transition-opacity hover:opacity-100 hover:text-blue-gray-100"
              ...
              <Typography
                ...
                className=" text-white antialiased text-xl transition-opacity hover:opacity-100 hover:text-blue-gray-100"
              >
                <svg
                  className="h-6 w-6"
                  fill="currentColor"
		...
		C56.434,52.847,46.23,58.136,35.936,63.474z"
          ...
          <div className=" flex  border-black flex-col  justify-end items-center pt-3 mt-[4rem] ">
          <div className=" mb-2 items-center drop-shadow-lg mr-12">
            ...
            <Typography
              variant="small"
              className=" text-center text-white antialiased  mb-1 md:mb-0"
            >
