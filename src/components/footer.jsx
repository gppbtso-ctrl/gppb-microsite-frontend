  ...
  return (
    <footer className=" w-full">
      <div className="mx-auto w-full  ">
        <section
          class={`${className} relative flex flex-col  w-full z-10  shadow-md gap-0.5 pt-[3rem] pb-4 px-16 backdrop-blur-3xl bg-gradient-to-b from-white/95 to-blue-500/95`}
        >
          <div className="flex flex-col md:flex-row justify-between mb-0 md:mb-3">
            <div className="">
              ...
              <svg  xmlns="http://www.w3.org/2000/svg" className="w-5" viewBox="0 0 122.88 85.57"><path d="M3.8,0,62.48,47.85,118.65,0ZM0,80.52,41.8,38.61,0,4.53v76ZM46.41,42.37,3.31,85.57h115.9L78,42.37,64.44,53.94h0a3,3,0,0,1-3.78.05L46.41,42.37Zm36.12-3.84,40.35,42.33V4.16L82.53,38.53Z"/></svg>
