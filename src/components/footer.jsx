      ...
      <div className="mx-auto w-full  ">
        ...
        <section class="relative flex flex-col  w-full z-10">
         ...
         GPPB-TSO Building, Commonwealth Ave, <br/>UP Diliman Campus, Quezon City
          ...
          <div className="w-fit  -ml-2 p-4 px-2  rounded-xl backdrop-blur-2xl bg-blue-500/30 border border-blue-500/15 flex gap-4 mt-2 text-blue-gray-900 shadow-lg">
          <Typography
            as="a"
        ...
        <div className="mt-0 flex w-full flex-col items-center justify-center pt-5 md:flex-row md:justify-between">
        <Typography
          variant="small"
