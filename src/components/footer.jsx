    ...
    <footer className="relative w-full">
      <div className="mx-auto w-full  ">
        <section class="relative flex flex-col  w-full z-10">
          <div className="shadow-sm bg  flex flex-col gap-0.5 pt-[2.3rem] pb-5 px-14  backdrop-blur-lg  bg-gradient-to-b from-white/95 to-blue-500/90">
            <Typography className="text-xl tracking-wide antialiased font-sans uppercase">
              Government Procurement Policy
            </Typography>
            <Typography className="text-xl tracking-wide  antialiased font-sans uppercase"></Typography>
            <Typography className="text-xl tracking-wide  antialiased font-sans uppercase">
