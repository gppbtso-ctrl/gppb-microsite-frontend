    ...
    <div class="mb-5 p-4 bg-white/95 rounded-md backdrop-filter shadow-lg flex flex-col  justify-center gap-3 w-[min(97%,30rem)] ">
      ...
      >
        {error ? (
          <Alert color="red" className="h-10 rounded-none flex items-center">
            ...
            {error === "required"
              ...
              : error === "succeeded"
              ? "Maximum of 3 committees only."
              : error === "less"
              ? "Select at least 3 committees."
              : null}
          </Alert>
        ) : null}
        ...
        <div class="w-full mt-2">
          <Typography
            variant="normal"
            className=" font-lead font-semibold antialiased"
          >
            Please provide a brief statement of your qualifications and
